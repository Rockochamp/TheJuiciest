...
connectButton.onclick = async () => {
  ...
  const sessionResponse = await fetchWithRetries(`${DID_API.url}/talks/streams`, {
    ...
    body: JSON.stringify({
      source_url: 'https://create-images-results.d-id.com/google-oauth2%7C116231323310569232177/upl_X3apDKOwatidbTG0S2GN7/image.png',
    }),
  });
...
talkButton.onclick = async () => {
  ...
  if (peerConnection?.signalingState === 'stable' || peerConnection?.iceConnectionState === 'connected') {
    const audioUrl = `https://github.com/Rockochamp/TheJuiciest/raw/main/bot2/bot2_${audioCounter}.mp3`; // Build the URL dynamically
